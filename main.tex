...
% this is the line that is under the "Allegheny County Health Department"
...
\begin{column}{\colwidth}
  % here, we start the first block of  "Air Quality Forecast"
  ...
  % here, we start the second block
...
% here, we begin the right column
\begin{column}{\colwidth}

  % here, we begin the block for ACHD Air Dispersion 36-Hour Forecast
